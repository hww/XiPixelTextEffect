...
{
    public class BitmapFontHeader
    {
        /// <summary>
        ///     Return font and index for given character
        /// </summary>
        /// <param name="code">Input character</param>
        /// <param name="font">Font table</param>
        /// <returns>Character index in font</returns>
        public static int GetCharacter(char code, ref byte[] font)
        {
            if (code < 0x80)
            {
                font = font8x8_basic;
            ...
            if (code < 0xA0)
            {
                font = font8x8_control;
                return ((int)code - 0x80) * 8;
            }
            if (code < 0x100)
            {
                font = font8x8_ext_latin;
                return ((int)code - 0xA0) * 8;
            }
            if (code >= 0x2500 && code <= 0x257F)
            {
                font = font8x8_box;
                return ((int)code - 0x2500) * 8;
            }
            if (code >= 0x2580 && code <= 0x259F)
            {
                font = font8x8_box;
                return ((int)code - 0x2580) * 8;
            }
            // other case return space
            Debug.LogError($"Font does not have character '{code}'");
            font = font8x8_basic;
            return 0;
        }
        ...
        private static readonly byte[] font8x8_control = {
        ...
        private static readonly byte[] font8x8_ext_latin = {
        ...
        private static readonly byte[] font8x8_greek = {
        ...
        // for later use
        private static readonly byte[] font8x8_misc = {
        ...
        private static readonly byte[] font8x8_box = {
        ...
        private static readonly byte[] font8x8_block = {
        ...
        private static readonly byte[] font8x8_hiragana = {
    ...
    private static readonly byte[] font8x8_sga = {
